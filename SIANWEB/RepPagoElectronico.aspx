        ...
        <table style="font-family: Verdana; font-size: 8pt">
            <tr>
             ...
             <td>
                ...
                <td><asp:Label ID="LblAcreedor" runat="server" Text="Acreedor" Visible="False" ></asp:Label></td>
                <td><telerik:RadCombobox ID="CmbAcreedor" runat="server" Visible="False" ></telerik:RadCombobox></td>
                ...
                <td>
                    ...
                    <MasterTableView>
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="Id_Cd" HeaderText="CDI" UniqueName="Id_Cd" Visible="true"></telerik:GridBoundColumn>
