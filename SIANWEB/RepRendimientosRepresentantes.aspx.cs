...
namespace SIANWEB
{
    public partial class RepRendimientosRepresentantes : System.Web.UI.Page
    {
        #region Variables
        ...
        private void Imprimir()
        {
            try
            {
                ...
                if (System.IO.File.Exists(Server.MapPath("~/Reportes") + "\\Rendimiento" + this.cmbanioini.SelectedValue + CerosMes + this.cmbmesini.SelectedValue + ".xlsx"))
                {
                    RAM1.ResponseScripts.Add(string.Concat(@"AbrirFacturaPDF('", "Reportes/Rendimiento" + this.cmbanioini.SelectedValue + CerosMes + this.cmbmesini.SelectedValue + ".xlsx", "')"));
                }
                else
                {
                    Alerta("No existe Rendimiento para este Periodo");
                }
