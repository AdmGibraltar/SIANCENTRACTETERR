				...
				<body>
					...
					<xsl:for-each select="Cliente">
						...
						<xsl:for-each select="ClienteDetalles/ClienteDetalle">
							...
							<table class="tabledetails" cellspacing="0" style="table-layout:auto">
								<tr>
									<td class="tdmargin" />
...
<br></br>
						...
						<xsl:for-each select="PlanesEspeciales/PlanEspecial">
							<table class="tabledetails" cellspacing="0"  >  <!-- style="table-layout:fixed"> -->
								<tr>
									...
									<td style="width:50px" align="right" >
										<xsl:value-of select="concat('$ ',format-number(Utilidad,  '###,##0.00'))" /> 
										<xsl:value-of select="translate(' ', ' ', '&#160;')"/>
									</td>
									<td style="width:50px" align="right" >
										<xsl:value-of select="concat(' ',format-number(Mezcla,  '###,##0.00'))" /> 
										<xsl:value-of select="translate(' ', ' ', '&#160;')"/>
									</td>
									<td style="width:60px" align="right" >
										<xsl:value-of select="concat(' ',format-number(Ponderacion,  '###,##0.00'))" /> 
										<xsl:value-of select="translate(' ', ' ', '&#160;')"/>
									</td>
									<td class="tdmargin" />
			...
			<table class="tabledetails" cellspacing="0"  >  <!-- style="table-layout:fixed"> -->
								<tr>
									...
									<td  class="negrita" style="width:55px" align="center" >
										 _____________
									</td>
			...
			<br></br>
								<table class="tabledetails" cellspacing="0"  >
										...
										<tr>
											...
											<td  class="negrita" style="width:50%" align="center">
												 Porcentaje de participación ponderado
											</td> 
											<td  class="negrita" style="width:17%" align="right" >
												  <!--  <xsl:value-of select="format-number(/Data/Parametros/ValorPPPP,  '##0.00')" /> -->
												  <!-- JFCV 02Mzo2018Calcula la ponderación-->
												  <xsl:value-of select="format-number(sum(PlanesEspeciales/PlanEspecial/Ponderacion),  '##0.00')" />
											</td>
										</tr>
								...
								<table class="tableedorescon" cellspacing="0"  >  
									...
									<tr>
										...
										<td style="width:350px" align="left" >
											Factor por porcentaje de participacion ponderado
										</td>
										<td style="width:120px" align="right" >
