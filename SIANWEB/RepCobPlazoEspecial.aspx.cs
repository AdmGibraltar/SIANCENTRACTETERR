...
namespace SIANWEB
{
    public partial class RepCobPlazoEspecial : System.Web.UI.Page
    {
        #region Variables
        ...
        private void Imprimir()
        {
            try
            {
                ...
                {
                    Alerta("Debe especificar los días de plazo normal");
                    return;
                }
                ...
                {
                    Alerta("Debe especificar el saldo minimo");
                    return;
                }
                if (this.TxtMeses.Text == string.Empty)
                {
                    Alerta("Debe especificar los meses a considerar");
                    return;
                }
                ...
                ALValorParametrosInternos.Add(this.TxtSaldoMinimo.Text);
                ALValorParametrosInternos.Add(this.TxtMeses.Text);
                if (this.ChkLegal.Checked) { ALValorParametrosInternos.Add(1); } else { ALValorParametrosInternos.Add(0); }
                if (this.ChkNacional.Checked) { ALValorParametrosInternos.Add(1); } else { ALValorParametrosInternos.Add(0); }

                Type instance = null;

                instance = typeof(LibreriaReportes.RepPlazoEspecial);
