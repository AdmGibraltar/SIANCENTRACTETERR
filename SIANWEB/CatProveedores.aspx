                        ...
                        <telerik:RadPageView ID="RadPageViewDGenerales" runat="server" >
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox ID="chkLocal" runat="server" Text="Proveedor local" />
                                    </td>
                                    <td>
                                        &nbsp;
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        &nbsp;
                                        <asp:CheckBox ID="chkFranquicia" runat="server" Text="Franquicia" />
                                    </td>
                                    <td>
                                        &nbsp;
                                    </td>
...
<CommandItemSettings ExportToPdfText="Export to Pdf"></CommandItemSettings>
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="Local" HeaderText="Local" UniqueName="Local"
                                                Visible="false">
                                            </telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridBoundColumn DataField="Franquicia" UniqueName="Franquicia" 
                                                Visible="False">
                                            </telerik:GridBoundColumn>
                                        </Columns>
        ...
        <telerik:radscriptblock id="RadScriptBlock1" runat="server">
            <script type="text/jscript" language="jscript">
                ...
                function LimpiarControles() {
                    ...
                    LimpiarCheckBox(document.getElementById('<%= chkLocal.ClientID %>'));
                    LimpiarCheckBox(document.getElementById('<%= chkFranquicia.ClientID %>'));
