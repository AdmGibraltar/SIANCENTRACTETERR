    ...
    public partial class CapFactura_Especial : System.Web.UI.Page
    {
        ...
        protected void rgFacturaEspecialDet_InsertCommand(object sender, GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                FacturaDet.Fac_Cant = (insertedItem["Fac_Cant"].FindControl("txtRem_Cantidad") as RadNumericTextBox).Value.HasValue ? (int)(insertedItem["Fac_Cant"].FindControl("txtRem_Cantidad") as RadNumericTextBox).Value.Value : 0;
