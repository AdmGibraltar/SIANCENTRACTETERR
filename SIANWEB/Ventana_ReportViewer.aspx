<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="Ventana_ReportViewer.aspx.cs"
    ...
    <%@ Register Assembly="Telerik.ReportViewer.WebForms" Namespace="Telerik.ReportViewer.WebForms" TagPrefix="tlk" %>
...
<body runat="server" id="body">
    ...
    <div runat="server" id="content" align="center">
        <tlk:reportviewer ID="ReportViewer1" runat="server" ProgressText="Generando..." Width="100%" Height="100%" >
