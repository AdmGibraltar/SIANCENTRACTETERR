...
namespace SIANWEB
{
    public partial class ProIndicadoresMensuales : System.Web.UI.Page
    {
        ...
        private void Descargar()
        {
            ...
            {
                Response.Clear();
                Response.AddHeader("Content-Disposition", "attachment; filename=IndicadoresMensuales.xls");
                Response.Flush();
                Response.TransmitFile("~/Documentos/IndicadoresMensuales.xls");
                Response.End();
