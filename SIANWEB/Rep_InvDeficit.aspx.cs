...
namespace SIANWEB
{
    public partial class Rep_InvDeficit : System.Web.UI.Page
    {
        #region Variables
        ...
        private void Imprimir(bool a_pantalla)
        {
            try
            {
                ...
                if (error == 0)
                {
                    ...
                    ALValorParametrosInternos.Add(chkControl.Checked ? "Si" : "No");
                    ...
                    ALValorParametrosInternos.Add(this.chkControl.Checked); // TRANSITO
                    ALValorParametrosInternos.Add(sesion.Emp_Cnx); // CADENA DE CONEXION A LA BASE DE DATOS

                    Type instance = null;
                    if (a_pantalla)
                    {
                        instance = typeof(LibreriaReportes.RepDeficit);
                    }
                    else
                    {
                        instance = typeof(LibreriaReportes.ExpRepDeficit);
                    }
