<%@ Page Title="Agrupar clientes" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.Master"
    AutoEventWireup="true" CodeBehind="CapAgruparClientes.aspx.cs" Inherits="SIANWEB.CapAgruparClientes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server"  >
   ...
   <script type="text/javascript">
       ...
       function TxtId_Agp_OnBlur(sender, args) {
           OnBlur(sender, $find('<%= CmbId_Agp.ClientID %>'));
       }


       function CmbId_Agp_ClientSelectedIndexChanged(sender, eventArgs) {
           ClientSelectedIndexChanged(eventArgs.get_item(), $find('<%= TxtId_Agp.ClientID %>'));
       }
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <NumberFormat DecimalDigits="0" GroupSeparator="" />
                                 ...
                                 <tr>
                                <td >
                                 <asp:Label ID="LblId_Cte" runat="server" Text="Cliente"></asp:Label>
                                </td>
                                <td >
                                    <telerik:RadNumericTextBox ID="TxtId_Cte" runat="server" MaxLength="9"  TabIndex="2"
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="LblCte" runat="server" Text="Nombre" Font-Bold="True"></asp:Label>
                                </td>
                                <td colspan = "9">
                                  <asp:Label ID="TxtCte" runat="server"  Font-Bold="True"></asp:Label></td>
                                
                            </tr>
                               <tr>
                                <td>
                                   <asp:Label ID="LblId_Agp" runat="server" Text="Agrupador" Font-Bold="True"></asp:Label></td>
                                <td >
                                   
                                    <telerik:RadNumericTextBox ID="TxtId_Agp" runat="server" MaxLength="9" MinValue="0" TabIndex="1"
                                                       Width="50px" >
                                                       <ClientEvents OnBlur="TxtId_Agp_OnBlur"  OnKeyPress="handleClickEvent" />
                                <NumberFormat DecimalDigits="0" GroupSeparator="" />
                                   ...
                                   <td colspan = "9">
                                    <telerik:RadComboBox ID="CmbId_Agp" runat="server" autopostback="true" CausesValidation="False"
                                                        ChangeTextOnKeyBoardNavigation="true" DataTextField="Descripcion" DataValueField="Id"
                                                        EnableLoadOnDemand="true" Filter="Contains" HighlightTemplatedItems="true" LoadingMessage="Cargando..."
                                                        MarkFirstMatch="true" MaxHeight="200px" OnClientBlur="Combo_ClientBlur" 
                                                         OnClientSelectedIndexChanged="CmbId_Agp_ClientSelectedIndexChanged"
                                                        Width="300px">
                                                      <ItemTemplate>
                                                            <table>
                                                                <tr>
