...
namespace SIANWEB
{
    public partial class Rep_InvCumplimientoEntregas : System.Web.UI.Page
    {
        #region Variables
        ...
        private void Imprimir(bool a_pantalla)
        {
            try
            {
                ...
                ALValorParametrosInternos.Add(cmbProveedor.SelectedValue);
                ALValorParametrosInternos.Add(Convert.ToDateTime(txtFecha1.SelectedDate).ToString("dd/MM/yyyy"));
                ALValorParametrosInternos.Add(Convert.ToDateTime(txtFecha2.SelectedDate).ToString("dd/MM/yyyy"));
                ALValorParametrosInternos.Add(txtFolio1.Text);
                ALValorParametrosInternos.Add(txtFolio2.Text);
                ...
                if (chkDetalle.Checked)
                {
                    if (a_pantalla)
                    {
                        instance = typeof(LibreriaReportes.Rep_InvCumplimientoEntregas);
                    }
                    else
                    {
                        instance = typeof(LibreriaReportes.ExpRep_InvCumplimientoEntregas);
                    }
                }
                else
                {
                    if (a_pantalla)
                    {
                        instance = typeof(LibreriaReportes.Rep_InvCumplimientoEntregas2);
                    }
                    else
                    {
                        instance = typeof(LibreriaReportes.ExpRep_InvCumplimientoEntregas2);
                    }
                }
