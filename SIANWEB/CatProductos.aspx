    ...
    <div class="formulario" id="divPrincipal" runat="server">
        ...
        <div runat="server" id="formularioProductos" style="margin-left: 10px; margin-right: 10px;">
            <telerik:RadTabStrip ID="RadTabStripPrincipal" runat="server" MultiPageID="RadMultiPagePrincipal"
                ...
                <Tabs>
                    <telerik:RadTab PageViewID="RadPageViewDGrales" Text="Datos <u>g</u>enerales " 
                        AccessKey="G" Selected="True">
                    </telerik:RadTab>
                    <telerik:RadTab PageViewID="RadPageViewParametros" Text="<u>P</u>arámetros" 
                        AccessKey="F">
                    </telerik:RadTab>
                            ...
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadNumericTextBox ID="TextId_Prd" runat="server" Width="50px" MaxLength="6"
                                                MinValue="1">
