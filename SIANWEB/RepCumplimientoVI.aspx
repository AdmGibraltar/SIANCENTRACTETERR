<%@ Page Title="Cumplimiento VI" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.master"
                    ...
                    <table>
                        <tr>
                           ...
                           <tr>
                            ...
                            <td>
                                <telerik:RadComboBox ID="cmbanio" runat="server" Width="200px" >
                                </telerik:RadComboBox>
                            </td>
                            <td>
                            </td>
                            ...
                            <td>
                                <telerik:RadComboBox ID="cmbmes" runat="server" Width="200px" >
                                </telerik:RadComboBox>
                            </td>
                            <td>
                            </td>
                              ...
                              <tr>
                            <td>
                                <asp:Label ID="Label1" Text="Región" runat="server">
                                </asp:Label>&nbsp;
                            </td>
                            <td>
                                <telerik:RadComboBox ID="cmbRegion" runat="server" Width="200px" >
                                </telerik:RadComboBox>
                            </td>
                            <td>
                            </td>
                            ...
                            <td colspan = 2 align = center>
                               ...
                               <asp:ListItem  Text = "Detalle" Value ="2"></asp:ListItem>
                                <asp:ListItem  Text = "Concentrado" Value ="3"></asp:ListItem>
