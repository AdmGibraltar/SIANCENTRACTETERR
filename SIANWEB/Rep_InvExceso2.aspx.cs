...
namespace SIANWEB
{
    public partial class Rep_InvExceso2 : System.Web.UI.Page
    {
        #region Variables
        ...
        protected void RadGrid1_ItemDataBound(object sender, GridItemEventArgs e)
        {
            try
            {
                if (e.Item is GridDataItem)
                {
                    ...
                    int DiasVer = Convert.ToInt32(Page.Request.QueryString["DiasVer"]);
                    int Tproducto = Convert.ToInt32(Page.Request.QueryString["Tproducto"]);
                    int ProveedorVer = Convert.ToInt32(item.GetDataKeyValue("Id_Pvd"));
                    ((e.Item as GridDataItem)["Id_Pvd"].Controls[0] as HyperLink).Attributes["onclick"] = "myJS(" + Proveedor + "," + Centro + "," + DiasVer + "," + Tproducto + "," + Indicador + "," + Dias + "," + ProveedorVer + ")";
                    ((e.Item as GridDataItem)["Pvd_Nombre"].Controls[0] as HyperLink).Attributes["onclick"] = "myJS(" + Proveedor + "," + Centro + "," + DiasVer + "," + Tproducto + "," + Indicador + "," + Dias + "," + ProveedorVer + ")";
