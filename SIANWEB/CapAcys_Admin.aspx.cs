    ...
    public partial class CapAcys_admin : System.Web.UI.Page
    {
        ...
        private void Imprimir(string Id_Acs)
        {
            try
            {
                ...
                ALValorParametrosInternos.Add(Convert.ToInt32(Id_Acs));
        ...
        private void renovar(GridItem gi)
        {
            try
            {
                if (gi.Cells[12].Text.ToString().ToLower() != "no")
                {
                    if (gi.Cells[3].Text.ToString().ToLower() == "i" || gi.Cells[3].Text.ToString().ToLower() == "a")
        ...
        private void autorizar(GridItem gi)
        {
            try
            {
                if (gi.Cells[12].Text.ToString().ToLower() != "si")
                {
                    if (gi.Cells[3].Text.ToString().ToLower() == "s" || gi.Cells[3].Text.ToString().ToLower() == "a")
