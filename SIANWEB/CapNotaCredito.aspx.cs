...
namespace SIANWEB
{
    public partial class CapNotaCredito : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    { //obtener valores desde la URL
                        ...
                        this.HdId_NcrSerie.Value= cmbConsFacEle.SelectedItem.Text;
                        this.cmbTipo.SelectedValue = "3";
        ...
        private void ConsultarDatosMovimiento_FacturaNotaCargo()
        {
            ...
            cmbTerritorio.Text = "";
            int id_territorio;
            string Cfe_NombreAcuse = string.Empty;
            ...
            switch (cmbMovimientoTipo.SelectedValue)
            {
                ...
                case "1": //factura
                    ...
                    cn_capfactura.ObtenerAcuse(sesion, 1, ref Cfe_NombreAcuse);
                    Factura factura = new Factura();
                    factura.Id_Emp = sesion.Id_Emp;
                    factura.Id_Cd = sesion.Id_Cd_Ver;
                    factura.Id_Fac = Consecutivo;
                    factura.Id_FacSerie = Cfe_NombreAcuse + Consecutivo;
                ...
                case "2": //nota de cargo
                    ...
                    cn_capfactura.ObtenerAcuse(sesion, 2, ref Cfe_NombreAcuse);
                    ...
                    notaCargo.Id_NcaSerie = Cfe_NombreAcuse + Consecutivo;
        ...
        private void LLenarFormNotaCredito(int Id_Emp, int Id_Cd, int Id_Ncr, string Id_NcrSerie)
        {
            ...
            new CN_CapNotaCredito().ConsultarAdenda(sesion.Id_Emp, sesion.Id_Cd_Ver, Id_Ncr, "5", "6", ref listCabT, ref listDetT, sesion.Emp_Cnx);
            ...
            CargarEspecial(Id_Ncr,Id_NcrSerie , sesion, notaCredito);

            //ADENDA            
            ConvertiraDt(notaCredito.ListaNotaCredito);
            rgNotaCreditoDet.Rebind();
        }
        private void CargarEspecial(int Id_Ncr,string Id_NcrSerie,  Sesion sesion, NotaCredito notaCredito)
        {
            //- Especial
                ...
                { //ADENDA
                    ...
                    if (Session["ListaProductosNotaCreditoEspecial" + Session.SessionID] != null)
                    {
                        if (Session["NcreditoEspecialGuardada" + Session.SessionID].ToString() == "1")
                        {
                            ...
                            if (Math.Round(totalEspecial, 2) != Math.Round(txtSubtotal.Value.Value, 2))
                            {
