...
namespace SIANWEB
{
    public partial class Rep_FacFacturacion : System.Web.UI.Page
    {
        #region Variables
        ...
        private void Imprimir(bool a_pantalla)
        {
            try
            {
                ...
                ALValorParametrosInternos.Add((cmbEstatus.SelectedValue == "-1" || cmbEstatus.SelectedValue == "Todos") ? string.Empty : cmbEstatus.SelectedValue);
                ALValorParametrosInternos.Add(cmbEstatus.SelectedValue == "-1" ? "Todos" : cmbEstatus.SelectedItem.Text);
                ALValorParametrosInternos.Add(sesion.Id_Emp);
                ALValorParametrosInternos.Add(sesion.Id_Cd_Ver);
                ALValorParametrosInternos.Add(sesion.Emp_Cnx);
                ALValorParametrosInternos.Add(dbcobranza);
