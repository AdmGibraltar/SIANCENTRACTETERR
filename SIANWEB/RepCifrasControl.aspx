<%@ Page Title="Cifras control" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.master"
    AutoEventWireup="true" CodeBehind="RepCifrasControl.aspx.cs" Inherits="SIANWEB.RepCifrasControl" %>
                ...
                <td>
                    <table>
                        <tr>
                            ...
                            <td>
                            <asp:CheckBox runat="Server" ID= "ChkExtemporaneo" Text = "Control extemporáneo" />
