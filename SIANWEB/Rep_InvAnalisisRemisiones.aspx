...
AutoEventWireup="true" CodeBehind="Rep_InvAnalisisRemisiones.aspx.cs" Inherits="SIANWEB.Rep_InvAnalisisRemisiones" %>
                ...
                <td>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label1" runat="server" Text="Tipo CD"></asp:Label>
                            </td>
                          
                            <td>
                                <asp:RadioButtonList runat= "server" ID = "RblTipoCd" 
                                    RepeatDirection="Horizontal" 
                                    onselectedindexchanged="RblTipoCd_SelectedIndexChanged" AutoPostBack="True">
                          ...
                          <tr>
                            ...
                            <td>
                                <telerik:RadComboBox ID="cmbCDI" runat="server" Width="200px"  
                                    OnSelectedIndexChanged="CmbCDI_SelectedIndexChanged" AutoPostBack="True">
                                </telerik:RadComboBox>
                            </td>
                             <td> &nbsp;
                            </td>
                        ...
                        <tr runat="server" id="TrNivelDet" visible="true">
                          <td> &nbsp;
                            </td>
                            <td>
                                <asp:Label ID="Label3" runat="server" Text="Tipo reporte"></asp:Label>
                            </td>
                            <td colspan="2">
                                <asp:RadioButtonList ID="rblNivel" runat="server">
                                    <asp:ListItem Selected="True" Value="D">General</asp:ListItem>
                                    <asp:ListItem Value="P">Detalle</asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                                                      <td> &nbsp;
                            </td>
