    ...
    public partial class wfrmRegistrarOportunidad : System.Web.UI.Page
    {
        ...
        protected void ibtnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (_PermisoGuardar)
                {
                    if (ddlAplicacion.Text == "" && DataGrid1.Items.Count == 0)                    
        ...
        private void ValidateCampana() {
            ...
            int aplicacion = !string.IsNullOrEmpty(ddlAplicacion.SelectedValue) ? Convert.ToInt32(ddlAplicacion.SelectedValue) : 0;
