...
namespace SIANWEB
{
    public partial class Rep_InvProductosAsignados : System.Web.UI.Page
    {
        #region Variables
        ...
        private void Imprimir(bool a_pantalla)
        {
            try
            {
                ...
                if (error == 0)
                {
                    ...
                    if (a_pantalla)
                    {
                        instance = typeof(LibreriaReportes.Rep_ProductosAsignados);
                    }
                    else
                    {
                        instance = typeof(LibreriaReportes.ExpRep_ProductosAsignados);
                    }
