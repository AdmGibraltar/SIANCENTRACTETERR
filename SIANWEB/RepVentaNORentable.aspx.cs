...
namespace SIANWEB
{
    public partial class RepVentaNORentable : System.Web.UI.Page
    {
        #region Variables
        ...
        private void Imprimir()
        {
            try
            {
               ...
               /* if (this.cmbmesfin.SelectedValue == "-1")
                ...
                ALValorParametrosInternos.Add(RblTipoCd.SelectedValue);
                ALValorParametrosInternos.Add(RblTipoReporte.SelectedValue);
                ALValorParametrosInternos.Add(RadioButtonList1.SelectedValue);
                if (txtCD.Text == "")
                {
                ...
                {
                    ALValorParametrosInternos.Add(txtCD.Text);
                }
                if (txtRIK.Text == "")
                {
                    ALValorParametrosInternos.Add("0");
                ...
                {
                    ALValorParametrosInternos.Add(txtRIK.Text);
                }
                if (txtTERR.Text == "")
                {
                    ALValorParametrosInternos.Add("0");
                ...
                {
                    ALValorParametrosInternos.Add(txtTERR.Text);
                }
                if (txtCte.Text == "")
                {
                    ALValorParametrosInternos.Add("0");
                ...
                {
                    ALValorParametrosInternos.Add(txtCte.Text);
                }
                ALValorParametrosInternos.Add(sesion.Emp_Cnx);
                if (RadioButtonList1.Text == "" || RadioButtonList1.Text == "0")
                {
                    ALValorParametrosInternos.Add("Todos");
                }
                else
                {
                    ALValorParametrosInternos.Add(RadioButtonList1.Text);
                }
                if (txtCD.Text == "")
                {
                    ALValorParametrosInternos.Add("Todos");
                ...
                ALValorParametrosInternos.Add(this.cmbmesini.Text);
                ALValorParametrosInternos.Add(DateTime.Now.ToShortDateString() + "  " + DateTime.Now.ToShortTimeString());

                Type instance = null;
                if (this.RblTipoReporte.SelectedValue == "1")
                {
                    instance = typeof(LibreriaReportes.Rep_VentaNORentableRegionCD);
                }
                else if (this.RblTipoReporte.SelectedValue == "2")
                {
                    instance = typeof(LibreriaReportes.Rep_VentaNORentableRegion);
                }
                else if (this.RblTipoReporte.SelectedValue == "3")
                {
                    instance = typeof(LibreriaReportes.Rep_VentaNORentableCDRik);
                }
                ...
                {
                    instance = typeof(LibreriaReportes.Rep_VentaNORentableCD);
                }
