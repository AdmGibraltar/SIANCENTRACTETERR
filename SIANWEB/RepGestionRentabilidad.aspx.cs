...
namespace SIANWEB
{
    public partial class RepGestionRentabilidad : System.Web.UI.Page
    {
        #region Variables
        ...
        private void Imprimir()
        {
            try
            {
                ...
                {
                    Alerta("Seleccione el mes inicial");
                    return;
                }
                if (this.cmbanioini.SelectedValue == "-1")
                {
                    Alerta("Seleccione el año inicial");
                    return;
                }
                ...
                if (this.cmbanioini.SelectedValue == "-1")
                {
                    Alerta("Seleccione el año final");
                    return;
                }
                ...
                String Filtro = "Periodo de " + this.cmbmesini.Text + "-" + cmbanioini.SelectedValue + " a " + this.cmbmesfin.Text + "-" + cmbaniofin.SelectedValue;

                ALValorParametrosInternos.Add(sesion.Emp_Cnx);
                ALValorParametrosInternos.Add(this.RblTipoCd.SelectedValue);
                ALValorParametrosInternos.Add(this.cmbmesini.SelectedValue);
                ALValorParametrosInternos.Add(this.cmbanioini.SelectedValue);
                ALValorParametrosInternos.Add(this.cmbmesfin.SelectedValue);
                ALValorParametrosInternos.Add(this.cmbaniofin.SelectedValue);
                ALValorParametrosInternos.Add(this.RblTipoReporte.SelectedValue);
                ALValorParametrosInternos.Add(Filtro);
          

                Type instance = null;
                if (this.RblTipoReporte.SelectedValue == "1")
                {
                    instance = typeof(LibreriaReportes.RepSegRentabilidad_Nivel1);
                }
                else if (this.RblTipoReporte.SelectedValue == "2")
                {
                    instance = typeof(LibreriaReportes.RepSegRentabilidad_Nivel2);
                }
                else if (this.RblTipoReporte.SelectedValue == "3")
                {
                    instance = typeof(LibreriaReportes.RepSegRentabilidad_Nivel3);
                }
                else if (this.RblTipoReporte.SelectedValue == "4")
                {
                    instance = typeof(LibreriaReportes.RepSegRentabilidad_Nivel4);
                }
                else if (this.RblTipoReporte.SelectedValue == "5")
                {
                    instance = typeof(LibreriaReportes.RepSegRentabilidad_Nivel5);
                }
                else if (this.RblTipoReporte.SelectedValue == "6")
                {
                    instance = typeof(LibreriaReportes.RepSegRentabilidad_Nivel6);
                }
