...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
                                    ...
                                    <telerik:RadGrid ID="rgAcuerdo" runat="server" AutoGenerateColumns="False" GridLines="None"
                                        ...
                                        <MasterTableView ClientDataKeyNames="Id_Acs,Id_Cte,Id_Ter">
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="Acs_FechaInicioDocumento" HeaderText="Fecha Inicio" UniqueName="Acs_Fecha"
                                                    DataFormatString="{0:dd/MM/yyyy}">
                                                    <HeaderStyle Width="80px" />
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn DataField="Acs_FechaFinDocumento" HeaderText="Fecha Fin" UniqueName="Acs_Fecha"
                                                    DataFormatString="{0:dd/MM/yyyy}">
                                                    <HeaderStyle Width="80px" />
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </telerik:GridBoundColumn>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function AbrirVentana_Acys(Id,Accion) {
                //debugger;
                var oWnd = radopen("CapAcys.aspx?Id=" + Id + "&Accion=" + Accion + "&PermisoGuardar=<%= _PermisoGuardar %>&PermisoModificar=<%= _PermisoModificar %>&PermisoEliminar=<%= _PermisoEliminar %>&PermisoImprimir=<%= _PermisoImprimir %>" , "AbrirVentana_Acys");
                oWnd.center();
                oWnd.Maximize();
            }
