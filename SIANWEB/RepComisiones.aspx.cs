...
namespace SIANWEB
{
    public partial class RepComisiones : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (rblReporte.SelectedValue == "x")
                {
                    ...
                    if (TxtId_Rik.Text == "")
                    {
                        ...
                        foreach (GridDataItem item in rgRiks.Items)//loops through each grid row
                        {
                            ...
                            if (((item.FindControl("chkEnviarMail")) as System.Web.UI.WebControls.CheckBox).Checked == true)
                            {
                                ...
                                {
                                    TxtId_Rik.Text = rik_seleccionado.ToString();


                                    destino = "rep" + cdi_seleccionado + TxtId_Rik.Text + "_" + this.cmbmes.SelectedValue + cmbanio.Text + id_Sistema.ToString() + ".html";
                                    ...
                                    pdfdestino = cdi_seleccionado + CerosA + TxtId_Rik.Text.Trim() + "_" + mes + cmbanio.Text + ".pdf";
                                    ...
                                    filename = "xsl_html_Comisiones_Origen" + cmbanio.Text + cmbmes.Text + TxtId_Rik.Text + ".xml";
                                    ...
                                    //comentarizado porque ya no se ocupa ya sale por formula 
                                    // solo falta corregir le de prueba el que trae toda la inforamacion 
                                    //-- Queryable Estatus el 18 creo para cuando ocupe grabarlo 
                                    //if (tipoRik_seleccionado != 3)
                                    //{
                                    //    string parte1 = impEdoConsolidado;
                                    //    int inicia = 0;
                                    //    inicia = impEdoConsolidado.IndexOf("(CBA) Comisión Base");
                                    //    parte1 = impEdoConsolidado.Substring(0, inicia);

                                    //    parte1 = parte1 + "(CBA) Comisión Base<span class=" + '"' + "tooltiptext" + '"';
                                    //    parte1 = parte1 + "></span></td><td style=" + '"' + "width:110px" + '"' + " align=" + '"' + "right" + '"' + " ><xsl:value-of select=" + '"' + "format-number((CB),";

                                    //    parte1 = parte1 + "'" + "###,##0.000" + "'" + ")" + '"' + " /> <xsl:value-of select=" + '"' + "translate(' ', ' ', '&#160;')" + '"' + "/> </td> </tr>";


                                    //    impEdoConsolidado = parte1;
                    ...
                    else
                    {
                        ...
                        #region cuando es solo un empleado

                        destino = "rep" + this.CmbId_Cd.SelectedValue.ToString() + TxtId_Rik.Text + "_" + this.cmbmes.SelectedValue + cmbanio.Text + id_Sistema.ToString() + ".html";
                        tiporeporte = 0;
                        ...
                        sistemaCompensacionGetXML.Anio = Convert.ToInt32(this.cmbanio.SelectedValue);
                        sistemaCompensacionGetXML.Mes = Convert.ToInt32(this.cmbmes.SelectedValue);
                        sistemaCompensacionGetXML.Id_Rik = Convert.ToInt32(this.cmbRik.SelectedValue);
                        sistemaCompensacionGetXML.MesTexto = this.cmbmes.Text;
                        sistemaCompensacionGetXML.RikNombre = this.cmbRik.Text;
                        sistemaCompensacionGetXML.Id_Representante = Convert.ToInt32(this.cmbRik.SelectedValue);
                        sistemaCompensacionGetXML.Id_TipoRepresentante = Convert.ToInt32(this.CmbTipo_Representante.SelectedValue);
                        ...
                        if (sistemaCompensacionGetXML.Clientes != null)
                        {
                            ...
                            pclientesXML = pclientesXML.Replace("{1}", this.TxtId_Rik.Text + " " + this.cmbRik.Text);
                            pclientesXML = pclientesXML.Replace("{2}", this.CmbId_Cd.SelectedValue + " " + this.CmbId_Cd.Text);
                            pclientesXML = pclientesXML.Replace("{5}", this.cmbmes.Text + ' ' + this.cmbanio.Text);
                            ...
                            //string ruta2 = Server.MapPath("~/Reportes") + "\\" + "resultado.html";
                            //string ruta = Server.MapPath("Reportes") + "\\archivoXml" + Sesion.Id_U.ToString() + "PagElec" + id_PagElec.ToString() + ".txt";
                            ...
                            //RAM1.ResponseScripts.Add(string.Concat(@"abrirArchivo('Reportes\\" + "rep" + Sesion.Id_Cd_Ver.ToString() + TxtId_Rik.Text + "_" + this.cmbmes.SelectedValue + cmbanio.Text + id_Sistema.ToString() + ".html" + "')"));
                            RAM1.ResponseScripts.Add(string.Concat(@"abrirArchivo('Reportes\\" + "rep" + this.CmbId_Cd.SelectedValue.ToString() + TxtId_Rik.Text + "_" + this.cmbmes.SelectedValue + cmbanio.Text + id_Sistema.ToString() + ".html" + "')"));
                            #endregion
                        }
                        #endregion
                ...
                if (rblReporte.SelectedValue == "b")
                {
                   

                    rgRiks.Visible = false;
                    rgRiksPrevio.Visible = true;
                    rgRiksPrevio.DataSource = Session["Table"];
                    //rgRiks.Rebind();
        ...
        protected void cmbEmpresa_Representante_SelectedIndexChanged(object sender, EventArgs e)
        {
            Sesion sesion = new Sesion();
            sesion = (Sesion)Session["Sesion" + Session.SessionID];
