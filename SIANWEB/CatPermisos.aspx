                                ...
                                <telerik:RadGrid ID="RadGridPermisos" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <MasterTableView NoMasterRecordsText="No existen registros que mostrar">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="Sp_PAccesar" UniqueName="SpTu_PAccesar" Display= "false" >
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Sp_PGrabar" UniqueName="SpTu_PGrabar" Display= "false" >
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Sp_PModificar" UniqueName="SpTu_PModificar" Display= "false" >
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Sp_PEliminar" UniqueName="SpTu_PEliminar" Display= "false" >
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Sp_PImprimir" UniqueName="SpTu_PImprimir" Display= "false" >
                                            </telerik:GridBoundColumn>
                                        </Columns>
                                    </MasterTableView>
                                </telerik:RadGrid>
