...
namespace SIANWEB
{
    public partial class Rep_NcreditoTipo : System.Web.UI.Page
    {
        #region Variables
        ...
        private void Mostrar(bool a_pantalla)
        {
            ...
            {
                conformidades.Clientes = txtClientes.Text;
                conformidades.SClientes = txtClientes.Text;
            }
            else
            ...
            if (dpFechaini.SelectedDate.HasValue)
            {
                ...
                conformidades.SFecha = dpFechaini.SelectedDate.Value.ToString("dd/MM/yyyy");
            ...
            if (dpFechafin.SelectedDate.HasValue)
            {
                ...
                conformidades.SFecha += " - " + dpFechafin.SelectedDate.Value.ToString("dd/MM/yyyy");
            }

            conformidades.Estatus = cmbEstatus.SelectedValue;
            conformidades.SEstatus = cmbEstatus.SelectedItem.Text.Replace("--","").Trim();
            conformidades.Tipo = Convert.ToInt32(cmbTipo.SelectedValue);
            conformidades.STipo = cmbTipo.SelectedItem.Text.Replace("--", "").Trim();
            ...
            ALValorParametrosInternos.Add(conformidades.Tipo);
            ALValorParametrosInternos.Add(conformidades.STipo);
            ALValorParametrosInternos.Add(conformidades.Estatus);
            ALValorParametrosInternos.Add(conformidades.SEstatus);
            ...
            if (a_pantalla)
            {
                instance = typeof(LibreriaReportes.Rep_NcreditoTipo);
            }
            else
            {
                instance = typeof(LibreriaReportes.ExpRep_NcreditoTipo);
            }
