 <%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.Master"
    AutoEventWireup="true" CodeBehind="ProCargaCompensacion.aspx.cs" Inherits="SIANWEB.ProCargaCompensacion" %>
                            ...
                            <telerik:RadGrid ID="RgDet" runat="server" GridLines="None" DataMember="listaConceptosNomina"
                                                    ...
                                                    <MasterTableView Name="Master" CommandItemDisplay="None" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <telerik:GridBoundColumn HeaderText="EMPRESA" UniqueName="EMPRESA" DataField="EMPRESA" Display="true"
                                                                ReadOnly="true">
                                                            </telerik:GridBoundColumn>
                                                            <telerik:GridBoundColumn HeaderText="Colaborador" UniqueName="Nomina" DataField="Nomina"
                                                                Display="true" ReadOnly="true">
                                                            </telerik:GridBoundColumn>
                                                            <telerik:GridBoundColumn HeaderText="Empleado" UniqueName="NOMBRE" DataField="NOMBRE"
                                                                Display="true" ReadOnly="true">
                                                            </telerik:GridBoundColumn>
                                                            <telerik:GridBoundColumn HeaderText="PUESTO" UniqueName="PUESTO"
                                                                DataField="PUESTO" Display="true" ReadOnly="true">
                                                            </telerik:GridBoundColumn>
                                                          ...
                                                          <telerik:GridTemplateColumn HeaderText="Sueldo" DataField="Sueldo" UniqueName="Sueldo">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblSueldo" runat="server" Text='<%# Eval("Sueldo") %>' />
                                                                </ItemTemplate>
                                                                <EditItemTemplate>
                                                              ...
                                                              <telerik:GridBoundColumn HeaderText="CuentadeGastos" UniqueName="CuentadeGastos"
                                                                DataField="CuentadeGastos" Display="true" ReadOnly="true">
                                                            </telerik:GridBoundColumn>

                                                            <telerik:GridBoundColumn HeaderText="Despensa" UniqueName="Despensa"
                                                                DataField="Despensa" Display="true" ReadOnly="true">
                                                            </telerik:GridBoundColumn>
                                                            <telerik:GridBoundColumn HeaderText="Gasolina" UniqueName="Gasolina"
                                                                DataField="Gasolina" Display="true" ReadOnly="true">
                                                            </telerik:GridBoundColumn>
                                                            <telerik:GridBoundColumn HeaderText="TOTAL" UniqueName="TOTAL"
                                                                DataField="TOTAL" Display="true" ReadOnly="true">
                                                            </telerik:GridBoundColumn>
