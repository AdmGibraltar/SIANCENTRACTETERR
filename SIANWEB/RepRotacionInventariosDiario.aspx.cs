...
namespace SIANWEB
{
    public partial class RepRotacionInventariosDiario : System.Web.UI.Page
    {
        #region Variables
        ...
        private void Imprimir()
        {
            try
            {
                ...
                if (this.RblTipoRep.SelectedValue == "2")
                {
                ...
                ALValorParametrosInternos.Add(this.RblTipoDesglose.SelectedValue);
                ALValorParametrosInternos.Add(this.RblTipoCd.SelectedValue);
                ALValorParametrosInternos.Add(this.RblTipoRep.SelectedValue == "1" ? null : this.cmbanio.SelectedValue);
                ALValorParametrosInternos.Add(this.RblTipoRep.SelectedValue == "1" ? null : this.cmbmes.SelectedValue);
                ALValorParametrosInternos.Add(this.RblTipoRep.SelectedValue == "2" ? null : this.dpFecha1.SelectedDate);
                if (this.RblTipoRep.SelectedValue == "1") 
                {
                    ALValorParametrosInternos.Add("Mes actual     Fecha: " +  Convert.ToDateTime (dpFecha1.SelectedDate).ToShortDateString());
                }
                else
                {
                    ALValorParametrosInternos.Add("Mes Cerrado     Mes / Año: " +  this.cmbmes.Text  + " / "  + this.cmbanio.Text);
                }

                Type instance = null;

                if (this.RblTipoDesglose.SelectedValue == "1")
                {
                    instance = typeof(LibreriaReportes.RepRotacionInventarioDiarioGral);
                }
                else
                {

                    instance = typeof(LibreriaReportes.RepRotacionInventarioDiario);
                }
