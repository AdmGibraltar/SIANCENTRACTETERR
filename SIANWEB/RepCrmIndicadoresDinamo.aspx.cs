...
namespace SIANWEB
{
    public partial class RepCrmIndicadoresDinamo : System.Web.UI.Page
    {
        #region Variables
        ...
        private void Imprimir()
        {
            try
            {
                ...
                //string conexion = "Data Source=10.1.0.165;Initial Catalog=sianwebcentralmar2016;User ID=sa;Password=sistemas";
                string conexion = System.Configuration.ConfigurationManager.AppSettings["Dinamo"].ToString();
                ...
                ALValorParametrosInternos.Add(this.RblTipoRik.SelectedValue);
                ...
                Type instance = null;
                if (!this.ChkListado.Checked)
                {
                    if (!ChkPromedio.Checked)
                    {
                        instance = typeof(LibreriaReportes.RepCrmIndicadoresDinamo);
                    }
                    else
                    {
                        instance = typeof(LibreriaReportes.RepCrmIndicadoresDinamoProm);
                    }
                }
                else
                {
                    if (!ChkPromedio.Checked)
                    {
                        ...
                        instance = typeof(LibreriaReportes.RepIndicadoresDinamoListRIK);
                    }
                    else 
                    {
                        instance = typeof(LibreriaReportes.RepIndicadoresDinamoListRIKTrim);
                    }
                }
