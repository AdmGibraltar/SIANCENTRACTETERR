...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
     ...
     <telerik:radajaxmanager id="RAM1" runat="server" enablepageheadupdate="False">
            ...
            <AjaxSettings>
                    ...
                    <telerik:AjaxSetting AjaxControlID="btnAceptar">
                     ...
                     <telerik:AjaxSetting AjaxControlID="btnRechazar">
                            <UpdatedControls>
      ...
      <telerik:RadWindowManager ID="RadWindowManager1" runat="server">
          ...
          <h3 style="font-family: Verdana;">Solicitud de Vinculación</h3>
    ...
    <div style="font-family: Verdana; font-size: 8pt; height:600px; overflow:auto" runat="server" id="divPrincipal">
