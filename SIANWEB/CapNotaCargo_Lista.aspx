...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function ToolBar_ClientClick(sender, args) {
                ...
                switch (button.get_value()) {
                    case 'new':
                        ...
                        AbrirVentana_NotaCargo(0, 0, 0, '1','0', permisoGuardar, permisoModificar, permisoEliminar, permisoImprimir);
                        break;
                }
            ...
            //--------------------------------------------------------------------------------------------------
            function AbrirVentana_NotaCargo_Edicion(Id_Emp, Id_Cd, Id_Nca_Editar,Id_NcaSerie, notaModificable) {
                AbrirVentana_NotaCargo(Id_Emp, Id_Cd, Id_Nca_Editar,Id_NcaSerie, notaModificable, permisoGuardar, permisoModificar, permisoEliminar, permisoImprimir);
            }

            //--------------------------------------------------------------------------------------------------
            //Abre la ventana de edición de factura
            //--------------------------------------------------------------------------------------------------
            function AbrirVentana_NotaCargo(Id_Emp, Id_Cd, Id_Nca,Id_NcaSerie, notaModificable, permisoGuardar, permisoModificar, permisoEliminar, permisoImprimir) {
               // debugger;
                ...
                <MasterTableView DataKeyNames="Id_Emp,Id_Cd,Id_Nca" ClientDataKeyNames="Id_Nca" CommandItemDisplay="Top"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Id_Nca" HeaderText="Clave" UniqueName="Id_Nca">
                          ...
                          <telerik:GridBoundColumn visible = "false" DataField="Id_NcaSerie" HeaderText="Id_NcaSerie" UniqueName="Id_NcaSerie">
                            <ItemStyle HorizontalAlign="Right" />
                            <HeaderStyle Width="50px" />
                        </telerik:GridBoundColumn>
