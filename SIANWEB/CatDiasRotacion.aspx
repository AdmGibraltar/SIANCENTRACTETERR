<%@ Page Title="Dias de Rotación" Language="C#" AutoEventWireup="true" CodeBehind="CatDiasRotacion.aspx.cs" Inherits="SIANWEB.CatDiasRotacion" 
            ...
            <telerik:RadAjaxPanel ID="ajaxFormPanel" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                ...
                <asp:Panel ID="Panel1" runat="server" DefaultButton="buttonSubmit">
                    <table>
                        ...
                        <tr><th>Especificaciones del documento a subir:</th></tr>
                        <tr><td>1.- Zona     -> Únicamente la clave de la zona. Ejemplo: 110 </td></tr>
                        <tr><td>2.- Saldo    -> Cantidades en millones.         Ejemplo: 1456256.00    </td></tr>
                        <tr><td>3.- Rotación -> Días de rotación deseados.      Ejemplo: 35</td></tr>
                        </table>
                    </table>
