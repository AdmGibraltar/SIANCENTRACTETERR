                ...
                <td>
                    ...
                    <table>
                        ...
                        <tr runat="server" id="txtRik" visible="false">
                            ...
                            <td colspan="2">
                                <%--<telerik:RadNumericTextBox ID="txtClienteId" Runat="server" Width="70px">
                                </telerik:RadNumericTextBox>--%>
                                <telerik:RadTextBox onpaste="return false" ID="RadTextBoxRik" runat="server" MaxLength="256">
                        ...
                        <tr runat="server" id="txtTerritorio" visible="false">
                            ...
                            <td colspan="2">
                                ...
                                <telerik:RadTextBox onpaste="return false" ID="RadTextBoxTerritorio" runat="server"
                                    MaxLength="256">
                                    <ClientEvents OnKeyPress="RangoEnterosSeparacionGuionYComas_OnKeyPress" OnBlur="RangoEnterosSeparacionGuionYComas_OnBlur" />
                                </telerik:RadTextBox>
                            </td>
                        ...
                        <tr runat="server" id="txtCliente" visible="false">
                            ...
                            <td colspan="2">
                                ...
                                <telerik:RadTextBox onpaste="return false" ID="RadTextBoxCliente" runat="server"
                                    MaxLength="256">
                                    <ClientEvents OnKeyPress="RangoEnterosSeparacionGuionYComas_OnKeyPress" OnBlur="RangoEnterosSeparacionGuionYComas_OnBlur" />
                                </telerik:RadTextBox>
                            </td>
