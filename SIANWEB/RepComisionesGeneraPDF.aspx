<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.Master" AutoEventWireup="true" CodeBehind="RepComisionesGeneraPDF.aspx.cs" Inherits="SIANWEB.RepComisionesGeneraPDF" %>
                ...
                <td>
                    <table>
                            ...
                            <td colspan="2">
                                <telerik:RadComboBox ID="cmbanio" runat="server" Width="150px">
                                    <Items>
                                        ...
                                        <telerik:RadComboBoxItem runat="server" Text="2022" Value="2025" />
                                        <telerik:RadComboBoxItem runat="server" Text="2014" Value="2026" />
                                        <telerik:RadComboBoxItem runat="server" Text="2015" Value="2027" />
                                        <telerik:RadComboBoxItem runat="server" Text="2022" Value="2028" />
                                        <telerik:RadComboBoxItem runat="server" Text="2014" Value="2029" />
                                        <telerik:RadComboBoxItem runat="server" Text="2015" Value="2030" />
                                    </Items>
                                </telerik:RadComboBox>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadComboBox ID="cmbEmpresa" runat="server" EnableCheckAllItemsCheckBox="false"
                                    Width="255" Label="" AutoPostBack="True"   OnSelectedIndexChanged="CmbEmpresa_SelectedIndexChanged" >
                                    <Items>
                                        <telerik:RadComboBoxItem Text="Key Quimica" Value="1" />
                                        <telerik:RadComboBoxItem Text="CNK" Value="2" />
                                        <telerik:RadComboBoxItem Text="FRANQUICIAS" Value="3" default />
                                    </Items>
                                </telerik:RadComboBox>
                            </td>
                            <td>
                        ...
                        <tr runat="server" id="trRik">
                            <td>
                                <asp:Label ID="LblId_Rik" Text="Representante" runat="server" Visible="false">
                                </asp:Label>&nbsp;
                            </td>
                            <td>
            ...
            <tr>
                <td>
                    <telerik:RadGrid ID="rgRiks" runat="server" AutoGenerateColumns="False" GridLines="None"
                        ...
                        PageSize="400" AllowPaging="True" MasterTableView-NoMasterRecordsText="No se encontraron registros."
