<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.master"
    AutoEventWireup="true" CodeBehind="ProCierre.aspx.cs" Inherits="SIANWEB.ProCierre" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:ImageButton ID="imgAceptar" runat="server" CssClass="aceptar" ImageUrl="~/Imagenes/blank.png"
                                    OnClick="imgAceptar_Click" ToolTip="Aceptar" OnClientClick ="javascript:return confirm('    ¿Esta seguro que desea realizar el cierre de mes?    ')" />
                            </td>
                        </tr>
                        <tr>
                            <td>
