...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server"> 
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function ToolBar_ClientClick(sender, args) {
                ...
                switch (button.get_value()) {
                    case 'new':
                        ...
                        AbrirVentana_Factura(0, 0, 0, '0', '1', permisoGuardar, permisoModificar, permisoEliminar, permisoImprimir); 
            ...
            function AbrirVentana_FacturaDepurar(Id_Emp, Id_Cd, Id_Fac, Id_FacSerie) 
            {
                var oWnd = radopen("ventana_FacIncobrable.aspx?Id_Fac=" + Id_Fac
                    + "&Id_Cd=" + Id_Cd
                    + "&Id_Emp=" + Id_Emp
                    + "&Id_FacSerie="+ Id_FacSerie
                    , "AbrirVentana_FacturaDepurar");
                oWnd.center();
            }

            function OpenAlert(mensaje, Id_Emp, Id_Cd, Id_Fac_Editar, Id_FacSerie,facModificable) {
                var abrirWindow = radalert(mensaje, 330, 150);
                abrirWindow.add_close(
                    function () {
                        AbrirVentana_Factura(Id_Emp, Id_Cd, Id_Fac_Editar,Id_FacSerie, facModificable, permisoGuardar, permisoModificar, permisoEliminar, permisoImprimir);
                    });
            }
            //--------------------------------------------------------------------------------------------------
            //Abre la ventana de edición de factura, cuando se edita seleccionandola del grid
            //--------------------------------------------------------------------------------------------------
            function AbrirVentana_Factura_Edicion(Id_Emp, Id_Cd, Id_Fac_Editar,Id_FacSerie, facModificable) {
                AbrirVentana_Factura(Id_Emp, Id_Cd, Id_Fac_Editar,Id_FacSerie, facModificable, permisoGuardar, permisoModificar, permisoEliminar, permisoImprimir);
            }
            ...
            //--------------------------------------------------------------------------------------------------
            function AbrirVentana_Factura(Id_Emp, Id_Cd, Id_Fac, Id_FacSerie, facModificable, permisoGuardar, permisoModificar, permisoEliminar, permisoImprimir) {
            ...
            //--------------------------------------------------------------------------------------------------
            function AbrirVentana_Factura_EdicionRefacturar(Id_Emp, Id_Cd, Id_Fac_Editar, Id_FacSerie,facModificable) {
                AbrirVentana_FacturaRefacturar(Id_Emp, Id_Cd, Id_Fac_Editar,Id_FacSerie,  facModificable, permisoGuardar, permisoModificar, permisoEliminar, permisoImprimir);
            }

            //--------------------------------------------------------------------------------------------------
            //Abre la ventana de edición de factura para refacturar
            //--------------------------------------------------------------------------------------------------
            function AbrirVentana_FacturaRefacturar(Id_Emp, Id_Cd, Id_Fac, Id_FacSerie,facModificable, permisoGuardar, permisoModificar, permisoEliminar, permisoImprimir) {
                var oWnd = radopen("CapFactura.aspx?Id_Fac=" + Id_Fac
                    + "&Id_Cd=" + Id_Cd
                    + "&Id_Emp=" + Id_Emp
                    + "&Id_FacSerie=" + Id_FacSerie 
    ...
    <telerik:RadToolBar ID="RadToolBar1" runat="server" Width="100%" dir="rtl" OnClientButtonClicking="ToolBar_ClientClick">
        <Items>
            ...
            <telerik:RadToolBarButton CommandName="facRemision" Value="facRemision" Text="" CssClass="facRemision"
                ToolTip="Facturar remisiones" ImageUrl="Imagenes/blank.png" />
        </Items>
    </telerik:RadToolBar>
                ...
                <td>
                    ...
                    <asp:Panel ID="aspPanel1" runat="server" ScrollBars="Horizontal" Width="900px" BorderStyle="Solid"
                        ...
                        <telerik:RadGrid ID="rgFactura" runat="server" AutoGenerateColumns="False" GridLines="None"
                            ...
                            <MasterTableView DataKeyNames="Id_Emp,Id_Cd,Id_Fac" ClientDataKeyNames="Id_Fac">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="Id_Fac" HeaderText="Factura" UniqueName="Id_Fac">
                                      ...
                                      <telerik:GridBoundColumn DataField="Id_FacSerie" visible = "false" HeaderText="Factura" UniqueName="Id_FacSerie">
                                        <ItemStyle HorizontalAlign="Right" />
                                        <HeaderStyle Width="60px" />
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridButtonColumn CommandName="Eliminar" HeaderText="Baja"  ConfirmDialogType="RadWindow"
                                        ConfirmText="¿Está seguro de dar de baja la factura?" ConfirmDialogHeight="150px"
