    ...
    <div id="divPrincipal" runat="server">
        <telerik:RadToolBar ID="rtb1" runat="server" Width="100%" dir="rtl" OnButtonClick="rtb1_ButtonClick">
            <Items>
                ...
                <telerik:RadToolBarButton CommandName="generarF" Value="generar" ToolTip="Generar facturas"
                    CssClass="new" ImageUrl="~/Imagenes/blank.png" />
                <telerik:RadToolBarButton CommandName="generarR" Value="generar" ToolTip="Generar remisiones"
                    CssClass="new" ImageUrl="~/Imagenes/blank.png" />
            </Items>
        </telerik:RadToolBar>
