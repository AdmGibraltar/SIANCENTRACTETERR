<%@ Page Title="Listado especial de clientes" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.master"
    AutoEventWireup="true" CodeBehind="RepCobPlazoEspecial.aspx.cs" Inherits="SIANWEB.RepCobPlazoEspecial" %>
                      ...
                      <tr>
                          ...
                          <tr>
                            ...
                            <td class="style1">
                                ...
                                <asp:Label ID="lblFIni0" Text="Clientes con venta promedio menor a" runat="server">
                                </asp:Label>
                            </td>
                            <td class="style1">
                        ...
                        <tr>
                            ...
                            <td>
                               <asp:CheckBox  runat= "server" ID= "ChkNacional" Text= "No incluir cuentas nacionales"/></td>
                            <td>
                            </td>
                        </tr>
                    </table>
