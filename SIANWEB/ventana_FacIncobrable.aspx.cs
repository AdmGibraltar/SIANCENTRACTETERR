 ...
 #region Funciones
        ...
        private void ConsultarDepuracionFactura()
        {
            try
            {
                ...
                factura.Id_FacSerie = Convert.ToString (Request.Params["Id_FacSerie"]);
                ...
                this.HdId_FacSerie.Value = Request.Params["Id_FacSerie"];
        ...
        private void Guardar()
        {
            ...
            try
            {
                ...
                factura.Id_FacSerie = this.HdId_FacSerie.Value;
