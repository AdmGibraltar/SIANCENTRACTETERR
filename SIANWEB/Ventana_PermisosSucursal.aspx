<%@ Page Title="Vincular sucursal" Language="C#" AutoEventWireup="true" CodeBehind="Ventana_PermisosSucursal.aspx.cs"
    Inherits="SIANWEB.Ventana_PermisosSucursal" %>
...
<body>
    ...
    <asp:Panel ID="PnlLogin" runat="server" >
        ...
        <asp:HiddenField runat="server" ID="HFId_U"></asp:HiddenField>
    </asp:Panel>
