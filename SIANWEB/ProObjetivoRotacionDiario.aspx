<%@ Page Title="Objetivos de rotación" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.Master"
    AutoEventWireup="true" CodeBehind="ProObjetivoRotacionDiario.aspx.cs" Inherits="SIANWEB.ProObjetivoRotacionDiario" %>
                ...
                <tr>
                    ...
                    <td>
                        <table>
                            ...
                            <tr>
                                <td>
                                   <asp:Label ID="LblId_CC" runat="server" Text="CDI"></asp:Label></td>
                                <td >
