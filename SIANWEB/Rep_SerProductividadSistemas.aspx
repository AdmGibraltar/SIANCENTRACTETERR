                    ...
                    <td>
                        <table border="0">
                            <tr>
                                ...
                                <td>
                                    <telerik:RadTextBox ID="txtGrupo" onpaste="return false" runat="server" Width="200px"
                                        MaxLength="1000">
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:Label ID="Label1" runat="server" Text="Representante"></asp:Label>
                                </td>
                                <td>
                                    <telerik:RadTextBox ID="txtRepresentante" onpaste="return false" runat="server" Width="200px"
                                        MaxLength="1000">
                                        <ClientEvents OnKeyPress="RangoEnterosSeparacionGuionYComas_OnKeyPress" OnBlur="RangoEnterosSeparacionGuionYComas_OnBlur" />
                                    </telerik:RadTextBox>
                                </td>
                        ...
                        <table>
                                ...
                                <td colspan="3">
                                    <telerik:RadComboBox ID="cmbOrden" runat="server" Width="300px">
                                        <Items>
                                            ...
                                            <telerik:RadComboBoxItem Text="Grupo de sistemas propietarios" Value="1" />
                                            <telerik:RadComboBoxItem Text="Equipos instalados" Value="2" />
                                            <telerik:RadComboBoxItem Text="Productividad" Value="3" />
                                            <telerik:RadComboBoxItem Text="Variación en pesos de unidades  no facturadas" Value="4" />
                                            <telerik:RadComboBoxItem Text="PAP" Value="5" />
                                        </Items>
                                    </telerik:RadComboBox>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:CheckBox ID="CheckBox1" runat="server" Text="Agrupar por sistema propietario" />
                                </td>
                                <td>
                                    &nbsp;
                                </td>
