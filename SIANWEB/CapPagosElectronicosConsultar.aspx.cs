    ...
    public partial class CapPagosElectoronicosModifica : System.Web.UI.Page
    {
        ...
        protected void rtb1_ButtonClick(object sender, RadToolBarEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                EnviarCorreoError(ex.Message, "rtb1_ButtonClick_2");
            }
        }
        ...
        private void EnviarCorreoError(string mensaje, string pantalla_evento)
        {
            try
            {
                ...
                //mail.To.Add(new MailAddress(configuracion.Mail_GastosFletes));
                mail.To.Add(new MailAddress("francisco.cepeda@bsdenterprise.com"));
                mail.To.Add(new MailAddress("jfcv@hotmail.com"));
                mail.Body = txtCuerpoMail;
                smtp.Send(mail);
