<%@ Page Title="Entradas CRM" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.master"
    AutoEventWireup="true" CodeBehind="RepCrmEntradasPivot.aspx.cs" Inherits="SIANWEB.RepCrmEntradasPivot" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    ...
    <div runat="server" id="divPrincipal">
        <telerik:RadToolBar ID="RadToolBar1" runat="server" Width="100%" dir="rtl" OnButtonClick="rtb1_ButtonClick">
            <Items>
                <telerik:RadToolBarButton CommandName="print" Value="print" CssClass="Excel" ToolTip="Generar"
