...
namespace SIANWEB
{
    public partial class CapNotaCargo_Lista : System.Web.UI.Page
    {
                    ...
                    switch (e.CommandName.ToString())
                    {
                        ...
                        case "Modificar":
                            ...
                            if (_PermisoModificar)
                                RAM1.ResponseScripts.Add(string.Concat(@"AbrirVentana_NotaCargo_Edicion('", Id_Emp, "','", Id_Cd, "','", Id_Nca, "','", Id_NcaSerie,"','",notaModificable, "')"));
                            else
                        ...
                        case "Imprimir":
                            ...
                            {
                                if (_PermisoImprimir)
                                    this.ImprimirNotaCargo(Id_Emp, Id_Cd, Id_Nca, Id_NcaSerie );
                                else
        ...
        private void ImprimirNotaCargo(int Id_Emp, int Id_Cd, int Id_Nca, string Id_NcaSerie)
        {
            try
            {
                Sesion sesion = (Sesion)Session["Sesion" + Session.SessionID];
                ...
                Comprobante.Attributes["MetodoPago"].Value = FormaPagoNombre(notaCargo.Nca_FPago);
