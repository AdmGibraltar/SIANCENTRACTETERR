<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage02.Master"
    AutoEventWireup="true" CodeBehind="CapFactura_Especial.aspx.cs" Inherits="SIANWEB.CapFactura_Especial" %>
                                ...
                                <telerik:RadGrid ID="rgFacturaEspecialDet" runat="server" GridLines="None" AllowPaging="false"
                                    ...
                                    <MasterTableView Name="Master" CommandItemDisplay="Top" DataKeyNames="Id_Fac,Id_FacDet,Id_Prd"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Cant." DataField="Fac_Cant" UniqueName="Fac_Cant">
                                                <HeaderStyle Width="60px" HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Right" />
                                                <ItemTemplate>
                                            ...
                                            <telerik:GridTemplateColumn DataField="Fac_Importe" HeaderText="Importe" UniqueName="Fac_Importe">
                                                ...
                                                <ItemStyle HorizontalAlign="Right" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblRem_Importe" runat="server" Text='<%# Eval("Fac_Importe", "{0:N2}") %>' />
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <asp:Label ID="lblRem_ImporteEdit" runat="server" Text='<%# Eval("Fac_Importe", "{0:N2}") %>' />
                                                </EditItemTemplate>
                                            </telerik:GridTemplateColumn>
