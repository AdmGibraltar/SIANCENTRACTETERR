...
namespace SIANWEB
{
    public partial class RepEntradasVirtuales : System.Web.UI.Page
    {
        #region Variables
        ...
        private void Imprimir()
        {
            try
            {
                ...
                {
                    ALValorParametrosInternos.Add("Totales");
                }
                else
                {
                    ALValorParametrosInternos.Add("Saldo");
                }
                ALValorParametrosInternos.Add(sesion.U_Nombre);

                Type instance = null;
                instance = typeof(LibreriaReportes.RepEntradasVirtuales);
