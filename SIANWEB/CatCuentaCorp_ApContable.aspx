<%@ Page Title="Cuenta corporativa" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.Master"
    AutoEventWireup="true" CodeBehind="CatCuentaCorp_ApContable.aspx.cs" Inherits="SIANWEB.CatCuentaCorp_ApContable" %>
                ...
                <tr>
                    ...
                    <td>
                        <table>
                            ...
                            <tr>
                                <td>
                                   <asp:Label ID="LblId_CC" runat="server" Text="Cuenta corporativa"></asp:Label></td>
                                <td >
                                    <telerik:RadComboBox ID="CmbId_CC" runat="server" AutoPostBack="True" CausesValidation="False"
                                                        ...
                                                        MarkFirstMatch="true" MaxHeight="200px"  OnSelectedIndexChanged="cmbIdCC_SelectedIndexChanged"
                                                        Width="300px">
                                                      <ItemTemplate>
                                                            <table>
                                                                <tr>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="LblCC_ApContable" runat="server" Text="Aplicación contable"></asp:Label></td>
                                <td>
                                   <telerik:RadTextBox ID="TxtCC_ApContable" runat="server" MaxLength="9" MinValue="0"
                                                       Width="100px" >
