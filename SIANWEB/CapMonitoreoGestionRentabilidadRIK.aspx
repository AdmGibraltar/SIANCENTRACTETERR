<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.master"
    AutoEventWireup="true" CodeBehind="CapMonitoreoGestionRentabilidadRIK.aspx.cs" Inherits="SIANWEB.CapMonitoreoGestionRentabilidadRIK" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function ToolBar_ClientClick(sender, args) {
                document.location.href = "CapMonitoreoGestionRentabilidad.aspx";
                ...
                <td>
                    ...
                    <asp:Panel ID="aspPanel1" runat="server" ScrollBars="Horizontal" Width="650px" BorderStyle="Solid"
                        ...
                        GridLines="None"
                            ...
                            <MasterTableView DataKeyNames="Id_Emp,Id_Cd,id_Rik,Mes,Anio" ClientDataKeyNames="Rik_Nombre">
                        ...
                        AddNewRecordText="Agregar"></CommandItemSettings>
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="Id_Rik" HeaderText="Id_Rik" Display="false" UniqueName="Id_Rik">
                                    </telerik:GridBoundColumn>
