...
namespace SIANWEB
{
    public partial class Rep_FacCanceladas : System.Web.UI.Page
    {
        #region Variables
        ...
        private void Abrir_Reporte(bool a_pantalla)
        {
            try
            {
                ...
                ALValorParametrosInternos.Add(RadioButtonList1.SelectedItem.Text);//operadas/no operadas
                ...
                ALValorParametrosInternos.Add(RadioButtonList1.SelectedValue == "1" ? "True" : "False");//operadas/no operadas
                //conexion
                ...
                if (a_pantalla)
                {
                    instance = typeof(LibreriaReportes.Rep_FacFacturasCanceladas);
                }
                else
                {
                    instance = typeof(LibreriaReportes.ExpRep_FacFacturasCanceladas);
                }
