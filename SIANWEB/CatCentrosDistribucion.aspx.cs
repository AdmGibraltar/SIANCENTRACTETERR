...
namespace SIANWEB
{
    public partial class CatCentrosDistribucion : System.Web.UI.Page
    {
        ...
        private void LlenarObjetoCentroDistribucion(ref CentroDistribucion cd)
        {
            ...
            cd.Dias = txtDias.Text == "" ? 0 : int.Parse(this.txtDias.Text);
            cd.DiasRevision = txtDiasRevision.Text == "" ? 0 : int.Parse(this.txtDiasRevision.Text);
        ...
        private void LlenarFormularioCentroDistribucion(int Id_Cd)
        {
            ...
            txtDias.Text = cd.Dias.ToString();
            txtDiasRevision.Text = cd.DiasRevision.ToString();
