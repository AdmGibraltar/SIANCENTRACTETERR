...
namespace SIANWEB
{
    public partial class Rep_IncidenciasMovs : System.Web.UI.Page
    {
        #region Variables
            ...
            try
            {
                ...
                else
                {
                    if (!Page.IsPostBack)
                    {
                        ...
                        this.dpFecha1.SelectedDate = Sesion.CalendarioIni;
                        this.dpFecha2.SelectedDate = Sesion.CalendarioFin;
        ...
        private void Imprimir()
        {
            try
            {
                ...
                instance = typeof(LibreriaReportes.RepIncidenciaMovimientos);
