                                    ...
                                    <div id="divGenerales" runat="server">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <telerik:RadDatePicker ID="dpFecha" runat="server" Width="120px">
                                        ...
                                        <MasterTableView CommandItemDisplay="Top" DataKeyNames="Id_Prd, Terr" EditMode="InPlace"
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridTemplateColumn DataField="Terr" HeaderText="Territorio" UniqueName="Terr">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="TerrLabelDesc" runat="server" Text='<%# Eval("DescrTer") %>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <telerik:GridTemplateColumn DataField="Precio" HeaderText="Precio" UniqueName="Precio">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="PrecioLabel" runat="server" Text='<%# Convert.ToDouble(Eval("Precio")).ToString("N") %>'></asp:Label>
                                                    </ItemTemplate>
