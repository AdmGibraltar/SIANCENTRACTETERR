<%@ Page Title="Reporte entradas virtuales" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.master"
    AutoEventWireup="true" CodeBehind="RepEntradasVirtuales.aspx.cs" Inherits="SIANWEB.RepEntradasVirtuales" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RadioButtonList ID="RblTipo" runat="server" RepeatDirection="Horizontal">
                                    <asp:ListItem Value="1" Selected="True">Totales</asp:ListItem>
