                                ...
                                <telerik:RadGrid ID="rg1" runat="server" AutoGenerateColumns="False" GridLines="None"
                                    ...
                                    <MasterTableView>
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="Contribucion" HeaderText="Contribucion" UniqueName="Contribucion"
                                                Visible="false">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Compensacion" HeaderText="Compensacion" UniqueName="Compensacion"
                                                Visible="false">
                                            </telerik:GridBoundColumn>
