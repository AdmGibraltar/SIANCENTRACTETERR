...
namespace SIANWEB
{
    public partial class CapAgruparClientes : System.Web.UI.Page
    {
        #region Variables
        ...
        private void CargarAgrupadores()
        {
            try
            {
                ...
                Sesion = (Sesion)Session["Sesion" + Session.SessionID];
                CapaNegocios.CN__Comun CN_Comun = new CapaNegocios.CN__Comun();
                CN_Comun.LlenaCombo(Sesion.Emp_Cnx, "SpCatAgrupadorEspecial_Combo", ref CmbId_Agp);
            }
            catch (Exception ex)
            {
        ...
        private void LimpiarCampos()
        {
            try
            {
                ...
                this.TxtId_Agp.Text = string.Empty;
                this.CmbId_Agp.Text = " -- Seleccionar -- ";
                this.CmbId_Agp.SelectedValue = "-1";
        ...
        private void Imprimir()
        {
            try
            {
                ...
                instance = typeof(LibreriaReportes.RepClientesAgrupador);
