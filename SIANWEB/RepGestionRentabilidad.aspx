<%@ Page Title="Gestión rentabilidad" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.master"
    AutoEventWireup="true" CodeBehind="RepGestionRentabilidad.aspx.cs" Inherits="SIANWEB.RepGestionRentabilidad" %>
                    ...
                    <table>
                        <tr>
                            ...
                            <td >
                               ...
                               <tr>
                            <td class="style1">
                                <asp:Label ID="Label3" Text="Mes incial" runat="server">
                                </asp:Label>&nbsp;
                            </td>
                            <td class="style1">
                            ...
                            <td class="style1">
                               ...
                               <tr>
                            <td>
                                <asp:Label ID="Label4" Text="Año inicial" runat="server">
                                </asp:Label>&nbsp;
                            </td>
                            <td>
                            ...
                            <td>
                              ...
                              <tr>
                            <td>
                               <asp:Label ID="Label1" Text="Mes final" runat="server">
                                </asp:Label>
                            </td>
                            <td>
                            ...
                            <td>
                              ...
                              <tr>
                            <td>
                              <asp:Label ID="Label2" Text="Año final" runat="server">
                                </asp:Label>
                            </td>
                            <td>
                            ...
                            <td>
                              <asp:RadioButtonList runat= "server" ID = "RblTipoReporte" RepeatDirection="Horizontal" >
                                ...
                                <asp:ListItem  Text="CDI" Value="2"></asp:ListItem>
                                ...
                                <asp:ListItem  Text="Acciones" Value="6"></asp:ListItem>
                              </asp:RadioButtonList>
                            </td>
