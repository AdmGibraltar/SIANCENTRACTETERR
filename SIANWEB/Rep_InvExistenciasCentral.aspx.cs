...
namespace SIANWEB
{
    public partial class Rep_InvExistenciasCentral : System.Web.UI.Page
    {
        #region Variables
        ...
        private void Imprimir()
        {
            try
            {
                ...
                ALValorParametrosInternos.Add(this.TxtId_AlmIni.Text);
                ALValorParametrosInternos.Add(this.TxtId_AlmFin.Text);
                ALValorParametrosInternos.Add(this.txtProducto.Text == "" ? null : this.txtProducto.Text);
                ALValorParametrosInternos.Add(this.txtProducto.Text == "" ? "Todos" : this.txtProducto.Text);
                ...
                if (this.RdblAgrupado.SelectedValue == "0")
                {
                    instance = typeof(LibreriaReportes.RepExistenciaCentral);
                }
                else
                {
                    instance = typeof(LibreriaReportes.RepExistenciaCentralProd);
                }
