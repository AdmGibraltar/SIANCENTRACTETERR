    ...
    public partial class RepProductos : System.Web.UI.Page
    {
        ...
        private void Imprimir()
        {
            try
            {
                ...
                ALValorParametrosInternos.Add(this.TxtId_Prd.Text == "" ? "0" : this.TxtId_Prd.Text);
                ALValorParametrosInternos.Add(this.TxtId_Pvd.Text == "" ? "0" : this.TxtId_Pvd.Text);
                ALValorParametrosInternos.Add(this.TxtId_Ptp.Text == "" ? "0" : this.TxtId_Ptp.Text);
                ALValorParametrosInternos.Add(this.TxtId_Cpr.Text == "" ? "0" : this.TxtId_Cpr.Text);
                ALValorParametrosInternos.Add(sesion.U_Nombre);

                Type instance = null;
                instance = typeof(LibreriaReportes.RepProductos);     
