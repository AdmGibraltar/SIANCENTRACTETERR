...
namespace SIANWEB
{
    public partial class Rep_Incidencias : System.Web.UI.Page
    {
        #region Variables
        ...
        private void Imprimir()
        {
            try
            {
                ...
                ALValorParametrosInternos.Add(this.cmbTipoError.SelectedValue  == "-1" ? null : this.cmbTipoError.SelectedValue);
                ALValorParametrosInternos.Add(sesion.U_Nombre);

                Type instance = null;

                instance = typeof(LibreriaReportes.RepErroresCentral);
