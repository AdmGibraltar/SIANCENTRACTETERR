<%@ Page Title="Clientes desbloqueo" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.Master"
    AutoEventWireup="true" CodeBehind="CapClientesBloqueo.aspx.cs" Inherits="SIANWEB.CapClientesBloqueo" %>
                            ...
                            <tr>
                               ...
                               <tr>
                                <td>
                                    &nbsp;</td>
                                <td colspan="3">
                                   <asp:CheckBox runat= "server" ID= "ChkBloquear" Text = "No bloquear cliente"/>
                                   </td>
