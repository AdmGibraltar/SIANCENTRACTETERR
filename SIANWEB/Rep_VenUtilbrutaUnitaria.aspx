                ...
                <td>
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <telerik:RadTextBox onpaste="return false" ID="txtTerritorio" runat="server" MaxLength="200">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <telerik:RadComboBox ID="cmbAñoIni" runat="server" Width="130px">
                                </telerik:RadComboBox>
                            </td>
                            <td>
                                <telerik:RadComboBox ID="cmbMesIni" runat="server" Width="130px">
                                </telerik:RadComboBox>
                            </td>
                            <td>
                                &nbsp;
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <telerik:RadComboBox ID="cmbAñoFin" runat="server" Width="130px">
                                </telerik:RadComboBox>
                            </td>
                            <td>
                                <telerik:RadComboBox ID="cmbMesFin" runat="server" Width="130px">
                                </telerik:RadComboBox>
                            </td>
                            <td>
                                &nbsp;
