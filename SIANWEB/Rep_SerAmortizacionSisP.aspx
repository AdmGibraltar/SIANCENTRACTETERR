<%@ Page Title="Amortización de sistemas propietarios" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.master"
    AutoEventWireup="true" CodeBehind="Rep_SerAmortizacionSisP.aspx.cs" Inherits="SIANWEB.Rep_SerSistemasPropietarios" %>
                ...
                <td>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <asp:RadioButton ID="rbEstadistica" runat="server" Text="Estadística de amortización"
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <asp:RadioButton ID="rbSaldo" runat="server" Text="Saldo por amortizar" GroupName="tipo" />
                            </td>
                            <td>
                                &nbsp;
                            </td>
