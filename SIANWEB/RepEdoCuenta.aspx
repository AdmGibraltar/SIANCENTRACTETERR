<%@ Page Title="Estado de cuenta por cliente" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.master"
    AutoEventWireup="true" CodeBehind="RepEdoCuenta.aspx.cs" Inherits="SIANWEB.RepEdoCuenta" %>
                ...
                <td>
                    <table>
                     <tr>
                        ...
                        <tr>
                        <td>
                        <asp:Label ID="Label4" Text="Buscar por:" runat="server">
                         </asp:Label>
                        </td>
                        <td>
                        <asp:RadioButtonList runat = "Server" ID ="RblTipo" RepeatDirection ="Horizontal"  AutoPostBack ="true"
                                onselectedindexchanged="RblTipo_SelectedIndexChanged">
                        <asp:ListItem Selected = "True" Text = "Cliente" Value ="1"></asp:ListItem>
                        <asp:ListItem  Text = "Cuenta nacional" Value ="2"></asp:ListItem>
                        <asp:ListItem  Text = "Agrupador" Value ="3"></asp:ListItem>
                      ...
                      <tr>
                            ...
                            <td>
                                <telerik:RadComboBox ID="CmbCDI" MaxHeight="300px" runat="server"  Width="250px" >
                                </telerik:RadComboBox>
                                </td>
                            <td>
                      ...
                      <tr runat ="Server" id="trCliente">
                            <td>
                                <asp:Label ID="LblNoCte" Text="No.Cte" runat="server">
                                </asp:Label></td>
                            <td>
                            ...
                            <td>
                                ...
                                <tr runat ="Server" id="trCNAg" visible= "false">
                            <td>
                                <asp:Label ID="LblCtaNacAg" Text="Cta. Nac./Agrupador" runat="server">
                                </asp:Label></td>
                            <td>
                                   <telerik:RadComboBox ID="CmbFiltro" MaxHeight="300px" runat="server"  Width="250px" >
