<%@ Page Title="Clientes desbloqueo por período" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.Master"
    AutoEventWireup="true" CodeBehind="CapClientesBloqueoPeriodo.aspx.cs" Inherits="SIANWEB.CapClientesBloqueoPeriodo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server"  >
   ...
   <script type="text/javascript">
    ...
    <asp:HiddenField ID="HF_Cve" runat="server" />
                                ...
                                <tr>
                                <td>
                                 <asp:Label ID="Label2" runat="server" Text="Fecha fin" Font-Bold="True"></asp:Label>
                                    &nbsp;</td>
                                <td colspan="3">
