namespace LibreriaReportes
{
    ...
    /// <summary>
    /// Summary description for repClienteMayorAdeucoDetalleBitacora.
    /// </summary>
    public partial class repClienteMayorAdeucoDetalleBitacora : Telerik.Reporting.Report
    {
        public repClienteMayorAdeucoDetalleBitacora()
        {
            try
            {
               InitializeComponent();
        ...
        private void repClienteMayorAdeucoDetalleBitacora_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
