namespace LibreriaReportes
{
    ...
    /// <summary>
    /// Summary description for Rep_ClienteMayorAdeudoDoc.
    /// </summary>
    public partial class Rep_ClienteMayorAdeudoDoc : Telerik.Reporting.Report
    {
        public Rep_ClienteMayorAdeudoDoc()
        {
            try
            {
                InitializeComponent();
        ...
        private void Rep_ClienteMayorAdeudoDoc_NeedDataSource(object sender, EventArgs e)
        {
            try 
            {
                ...
                this.sqlDataAdapter1.SelectCommand.Parameters["@Cd"].Value = this.ReportParameters["Id_Cd"].Value;
