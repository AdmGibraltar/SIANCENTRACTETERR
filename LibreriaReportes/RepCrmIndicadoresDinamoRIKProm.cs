namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepIndicadoresDinamoRIKProm : Telerik.Reporting.Report
    {
        public RepIndicadoresDinamoRIKProm()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepCrmIndicadoresDinamoRIKProm_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
                Telerik.Reporting.Processing.Report rptq = (Telerik.Reporting.Processing.Report)sender;
                this.textBox3.Value = "INDICADORES DINAMO | PROMEDIO 3 MESES ";
