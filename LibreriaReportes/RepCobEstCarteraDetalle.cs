namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class ResumenCartera : Telerik.Reporting.Report
    {
        ...
        private void RepCobEstCarteraDetalle_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
                Telerik.Reporting.Processing.Report rptq = (Telerik.Reporting.Processing.Report)sender;

                this.textBox3.Value = "Detalle de cartera " + rptq.Parameters["CdiNombre"].Value.ToString();
                ...
                this.sqlDataAdapter1.SelectCommand.Parameters["@Cte"].Value = rptq.Parameters["Id_Cte"].Value;
