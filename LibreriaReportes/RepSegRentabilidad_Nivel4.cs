namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepSegRentabilidad_Nivel4 : Telerik.Reporting.Report
    {
        public RepSegRentabilidad_Nivel4()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepSegRentabilidad_Nivel4_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
