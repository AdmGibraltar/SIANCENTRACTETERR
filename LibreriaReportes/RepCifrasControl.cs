namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepCifrasControl : Telerik.Reporting.Report
    {
        public RepCifrasControl()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepCifrasControl_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
