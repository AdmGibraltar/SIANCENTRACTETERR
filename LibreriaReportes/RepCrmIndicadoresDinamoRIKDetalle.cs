namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepIndicadoresDinamoRIKDetalle : Telerik.Reporting.Report
    {
        public RepIndicadoresDinamoRIKDetalle()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepCrmIndicadoresDinamoRIKDetalle_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
                Telerik.Reporting.Processing.Report rptq = (Telerik.Reporting.Processing.Report)sender;
                this.textBox3.Value = "INDICADORES DINAMO | " + rptq.Parameters["RikNombre"].Value + " " + rptq.Parameters["MesStr"].Value + " " + rptq.Parameters["Anio"].Value;
