namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepCobEstDetalleBitacora : Telerik.Reporting.Report
    {
        public RepCobEstDetalleBitacora()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepCobEstDetalleBitacora_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
