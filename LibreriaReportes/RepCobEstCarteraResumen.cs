namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepCobEstCarteraResumen : Telerik.Reporting.Report
    {
        public RepCobEstCarteraResumen()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepCobEstCarteraResumen_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
