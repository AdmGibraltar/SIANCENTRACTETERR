namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepCobAntiguedadSaldosCte : Telerik.Reporting.Report
    {
        public RepCobAntiguedadSaldosCte()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepCobAntiguedadSaldosCte_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
                ...
                this.textBox3.Value = "Antiguedad de saldos " + rptq.Parameters["CdiNombre"].Value;
