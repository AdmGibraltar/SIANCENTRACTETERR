namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepCobEstDetalleDocumento : Telerik.Reporting.Report
    {
        public RepCobEstDetalleDocumento()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepCobEstDetalleDocumento_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
