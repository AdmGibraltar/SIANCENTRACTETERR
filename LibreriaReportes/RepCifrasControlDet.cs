namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepCifrasControlDet : Telerik.Reporting.Report
    {
        public RepCifrasControlDet()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepCifrasControlDet_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
                ...
                this.textBox3.Value = "Cifras control " + rptq.Parameters["MesStr"].Value + " " + rptq.Parameters["Anio"].Value;
