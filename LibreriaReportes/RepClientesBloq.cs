namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepClientesBloq : Telerik.Reporting.Report
    {
        public RepClientesBloq()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepClientesBloq_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
