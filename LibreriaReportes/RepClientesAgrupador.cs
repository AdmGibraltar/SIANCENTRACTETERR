namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepClientesAgrupador : Telerik.Reporting.Report
    {
        public RepClientesAgrupador()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepClientesAgrupador_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
