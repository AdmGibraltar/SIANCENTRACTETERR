namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepCobAntiguedadSaldos : Telerik.Reporting.Report
    {
        public RepCobAntiguedadSaldos()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepCobAntiguedadSaldos_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
