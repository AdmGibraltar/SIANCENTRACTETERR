namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepCobEstDetalleRastreo : Telerik.Reporting.Report
    {
        public RepCobEstDetalleRastreo()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepCobEstDetalleRastreo_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
