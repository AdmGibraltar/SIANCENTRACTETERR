namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepSegRentabilidad_Nivel6 : Telerik.Reporting.Report
    {
        public RepSegRentabilidad_Nivel6()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepSegRentabilidad_Nivel6_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
