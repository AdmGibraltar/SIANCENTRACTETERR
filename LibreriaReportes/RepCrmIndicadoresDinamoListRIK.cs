namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepIndicadoresDinamoListRIK : Telerik.Reporting.Report
    {
        public RepIndicadoresDinamoListRIK()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepCrmIndicadoresDinamoListRIK_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
