namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepSegRentabilidad_Nivel3 : Telerik.Reporting.Report
    {
        public RepSegRentabilidad_Nivel3()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepSegRentabilidad_Nivel3_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
