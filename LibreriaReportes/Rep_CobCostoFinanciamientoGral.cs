namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class Rep_CobCostoFinanciamientoGral : Telerik.Reporting.Report
    {
        public Rep_CobCostoFinanciamientoGral()
        {
            try
            {
                InitializeComponent();
        ...
        private void Rep_CobCostoFinanciamientoGral_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
