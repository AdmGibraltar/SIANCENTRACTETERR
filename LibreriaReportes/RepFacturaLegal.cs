namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepFacturaLegal : Telerik.Reporting.Report
    {
        public RepFacturaLegal()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepFacturaLegal_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
