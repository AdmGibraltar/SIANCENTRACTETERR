namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepCobEstCarteraResumenCte : Telerik.Reporting.Report
    {
        public RepCobEstCarteraResumenCte()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepCobEstCarteraResumenCte_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
