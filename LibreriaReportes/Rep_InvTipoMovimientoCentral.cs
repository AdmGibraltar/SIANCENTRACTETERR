namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class Rep_InvTipoMovimientoCentral : Telerik.Reporting.Report
    {
        public Rep_InvTipoMovimientoCentral()
        {

            InitializeComponent();
            this.DataSource = null;
        }
        private void Rep_InvTipoMovimientoCentral_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
