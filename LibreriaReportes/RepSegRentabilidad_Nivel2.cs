namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepSegRentabilidad_Nivel2 : Telerik.Reporting.Report
    {
        public RepSegRentabilidad_Nivel2()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepSegRentabilidad_Nivel2_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
