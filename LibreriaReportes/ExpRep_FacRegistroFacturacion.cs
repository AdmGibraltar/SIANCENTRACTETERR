namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class ExpRep_FacRegistroFacturacion : Telerik.Reporting.Report
    {
        public ExpRep_FacRegistroFacturacion()
        {
            /// <summary>
        ...
        private void Rep_FacRegistroFacturacion_NeedDataSource(object sender, EventArgs e)
        {
            ...
            this.sqlDataAdapter1.SelectCommand.Parameters["@dbcobranza"].Value = this.ReportParameters["dbcobranza"].Value;
