namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepPlazoEspecialDetalle : Telerik.Reporting.Report
    {
        public RepPlazoEspecialDetalle()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepPlazoEspecialDetalle_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
                Telerik.Reporting.Processing.Report rptq = (Telerik.Reporting.Processing.Report)sender;

                this.textBox3.Value = "Listado especial de clientes " + rptq.Parameters["CdiNombre"].Value;
