namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepSegRentabilidad_Nivel1 : Telerik.Reporting.Report
    {
        public RepSegRentabilidad_Nivel1()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepSegRentabilidad_Nivel1_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
