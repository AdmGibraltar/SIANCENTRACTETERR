namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepCrmIndicadoresDinamoProm : Telerik.Reporting.Report
    {
        public RepCrmIndicadoresDinamoProm()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepCrmIndicadoresDinamoProm_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
                string TipoCd = this.ReportParameters["TipoCD"].Value.ToString() == "1" ? "CDI" : "CDC";  
                this.textBox3.Value = "INDICADORES DINAMO |"+ TipoCd +" PROMEDIO 3 MESES ";
