...
namespace CapaNegocios
{
    public class CN_CapNotaCredito
    {
        ...
        public void ConsultarAdenda(int Id_Emp, int Id_Cd_Ver, int Id_Ncr, string Tipo1, string Tipo2, ref List<AdendaDet> listCabT, ref List<AdendaDet> listDetT, string Conexion)
        {
            try
            {
                CD_CapNotaCredito CDCapNotaCredito = new CD_CapNotaCredito();
                CDCapNotaCredito.ConsultarAdenda(Id_Emp, Id_Cd_Ver, Id_Ncr, Tipo1, Tipo2, ref  listCabT, ref listDetT, Conexion);
            }
            catch (Exception ex)
            {
                throw ex;
