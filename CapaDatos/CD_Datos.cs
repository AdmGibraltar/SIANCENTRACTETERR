...
namespace CapaDatos
{
    public class CD_Datos
    {
        ...
        public SqlCommand GenerarSqlCommandNulls(string SP, ref  SqlDataReader dr, string[] parametros, object[] resultados)
        {
            SqlCommand functionReturnValue = default(SqlCommand);
            try
            {
        ...
        public SqlCommand GenerarSqlCommand_NonqueryConexionReciclada(string SP, string[] parametros, object[] resultados)
        {
            SqlCommand functionReturnValue = default(SqlCommand);
            try
            {
        ...
        public SqlCommand GenerarSqlCommandConexionReciclada(string SP, ref  SqlDataReader dr, string[] parametros, object[] resultados)
        {
            SqlCommand functionReturnValue = default(SqlCommand);
            try
            {
