...
namespace CapaDatos
{
    public class CD_CapPagoElectronico
    {
                        ...
                        if (pagoElectronico.PagElec_Soporte != null)
                        {
                            pagoElectronico.PagElecArchivo.Add(
                                    new PagoElectronicoArchivo(
                                        ...
                                        (int?)pagoElectronico.Id_PagElec,
                                        9999, //partida
                                        pagoElectronico.PagElec_Soporte,
                                        (byte[])null, //XML
       ...
       public void ConsultaPagoElectronicoAutorizacion(PagoElectronico pagoElectronico, string Conexion)
        ...
        public void ImportarPagoElectronico(string Conexion, ref int verificador)
        {
            CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("SpImportaPagoElectronico", ref verificador, Parametros, Valores);
        ...
        public void ImportarGastoViaje(string Conexion, ref int verificador)
        {
            CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("SpImportaGastosdeViaje", ref verificador, Parametros, Valores);
