    ...
    public class CD_CapRemision
    {
        ...
        public void BajaRemision(ref Remision remision, ref List<RemisionDet> detalles, Sesion sesion, ref int verificador)
        {
            ...
            try
            {
                ...
                string[] ParametrosEst = { "@Id_Emp", "@Id_Cd", "@Id_Rem", "@Rem_Estatus" };
                object[] ValoresEst = { remision.Id_Emp, remision.Id_Cd, remision.Id_Rem, remision.Rem_Estatus };
        ...
        public void ReporteAnalisisdeRemisiones(int id_emp, DateTime fechaini, DateTime fechafin, string conexion, ref int verificador )
        {
            try
            {
                ...
                //string[] Valores = {
                //                        Convert.ToString(id_emp),
                //                       Convert.ToString(fechaini),
                //                       Convert.ToString(fechafin)
                //                   };

                object[] Valores = { id_emp, fechaini, fechafin };

                sqlcmd = CapaDatos.GenerarSqlCommand("spRep_RemisionesVencidasGral2", ref verificador, Parametros, Valores);
