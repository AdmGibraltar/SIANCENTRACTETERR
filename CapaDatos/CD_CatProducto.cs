    ...
    public class CD_CatProducto
    {
        ...
        public void ConsultaProducto(ref Producto producto, string Conexion, int id_Emp, int id_Cd, int id_Cd_Ver, int id_Prd)
        {
            try
            {
                ...
                string[] Parametros = { "@Id_Emp", "@Id_Cd", "@Id_Cd_Ver", "@Id_Prd", "@Id_Ter", "@Id_Cte", "@EmpBen" };
                object[] Valores = { id_Emp, 
                                       id_Cd <= 0 ? (object)null : id_Cd,
                                       id_Cd_Ver, 
                                       id_Prd,
        ...
        public void ActualizaDocumentos(Sesion sesion, ref int Verificador)
        {
            try
            {
                ...
                SqlCommand sqlcmd = cd_datos.GenerarSqlCommand("spActualizaDocumentos", ref Verificador);
        ...
        public void ActualizaCostos(Sesion sesion, ref int Verificador)
        {
            ...
            {
                 CD_Datos cd_datos = new CD_Datos(sesion.Emp_Cnx);
                 CD_Datos cd_datos2 = new CD_Datos(sesion.Emp_Cnx);
                 CD_Datos cd_datos3 = new CD_Datos(sesion.Emp_Cnx);
                 CD_Datos cd_datos4 = new CD_Datos(sesion.Emp_Cnx);
                 String[] Parametros = {"@Id_Emp", "@Id_Cd"};
                ...
                //Primero actualizo los productos 
                 SqlCommand sqlcmd3 = cd_datos3.GenerarSqlCommand("SpActualizaProdsCentral", ref Verificador3);
                 cd_datos3.LimpiarSqlcommand(ref sqlcmd3);

                //Actualizo los costos que esten en macola
                SqlCommand sqlcmd = cd_datos.GenerarSqlCommand("SpActualizarCostos", ref Verificador, Parametros, Valores);
                cd_datos.LimpiarSqlcommand(ref sqlcmd);

                //Actualizo los costos que de compras locales
                SqlCommand sqlcmd2 = cd_datos2.GenerarSqlCommand("spActualizaCostos_ComprasLocales", ref Verificador2, Parametros, Valores);
                Verificador = Verificador + Verificador2;
                cd_datos2.LimpiarSqlcommand(ref sqlcmd2);

                //Actualizo el costo a los códigos usados 
                SqlCommand sqlcmd4 = cd_datos4.GenerarSqlCommand("spActualizaCostos_CodigoUsado", ref Verificador4, Parametros, Valores);
                Verificador = Verificador + Verificador4;
                cd_datos4.LimpiarSqlcommand(ref sqlcmd4);
