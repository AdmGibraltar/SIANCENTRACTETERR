    ...
    public class CD_CapFactura
    {
        ...
        public void ConsultaFactura(ref Factura factura, ref List<FacturaDet> listaFacturaDet, string Conexion)
        {
            try
            {
                ...
                string[] Parametros = { "@Id_Emp", "@Id_Cd", "@Id_Fac", "@Id_FacSerie" };
                object[] Valores = { factura.Id_Emp, factura.Id_Cd, factura.Id_Fac, factura.Id_FacSerie };
        ...
        public void ConsultaFacturaEspecialDetalle(ref List<FacturaDet> listaFacturaProductos, string Conexion, int id_Emp, int id_Cd, int id_Fac,string Id_FacSerie,int id_Cte)
        {
            try
            {
                ...
                string[] Parametros = { "@Id_Emp", "@Id_Cd", "@Id_Fac" , "@Id_FacSerie"};
                object[] Valores = { id_Emp, id_Cd, id_Fac , Id_FacSerie};
                ...
                while (dr.Read())
                {
                    ...
                    facturaDet.Id_Prd = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Prd")));
                    facturaDet.Fac_Cant = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Fac_Cant"))) ? 0 : Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Fac_Cant")));
        ...
        public void ConsultaFactura_Buscar(Factura factura, string Conexion, ref List<Factura> List
            ...
            , int id_Ped_fin, bool? acuse, bool? depuracion, int id_U)
        {
            try
            {
                SqlDataReader dr = null;
                ...
                while (dr.Read())
                {
                    ...
                    factura.Id_Cd = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Cd")));
                    factura.Id_Fac = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Fac")));
                    factura.Id_FacSerie = dr["Id_FacSerie"].ToString();
    ...
    ref List<EntradaSalida> listaEntSalRemisiones, List<AdendaDet> listAdendaCabecera, string arrayRemisiones, ref EntradaSalida entSal, ref List<EntradaSalidaDetalle> listaEntSalDetalle, ref FacturaEspecial facturaEsp, ref   List<FacturaDet> listaProductosFacturaEspecial, bool actualizar)
        {
            ...
            try
            {
                ...
                if (factura.Id_Tm == 51)
                {
                    ...
                    fac.Id_FacSerie = factura.Id_FacSerie+ factura.Id_Fac;
                ...
                if (generarVerificador == 1 && porciento > 0)
                {
                    ...
                    string Id_NcrSerie = string.Empty;

                    cd_nc.ConsultarIdNotaCredito (factura.Id_Fac, factura.Id_Cd, factura.Id_Emp, ref Id_Ncr, ref Estatus,ref Id_NcrSerie,sesion.Emp_Cnx);
                    if (Estatus != "B")
                    {
                        notaCredito.Id_Emp = factura.Id_Emp;
                        notaCredito.Id_Cd = factura.Id_Cd;
        ...
        public void Rastreo(ref Factura fac, string Conexion)
        {
            try
            {
                ...
                string[] Parametros = { "@Id_Emp", "@Id_Cd", "@Id_FacSerie" };
                object[] Valores = { fac.Id_Emp, fac.Id_Cd, fac.Id_FacSerie };
        ...
        public void ConsultarAdenda(int Id_Emp, int Id_Cd_Ver, int Id_Fac, string Id_FacSerie,string Tipo1, string Tipo2, ref List<AdendaDet> listCab, ref List<AdendaDet> listDet, string Conexion)
        {
            try
            {
                SqlDataReader dr = null;
        ...
        public void ArchivoPdf_Xml(ref Factura fac, string Conexion)
        {
            try
            {
                ...
                string[] Parametros = { "@Id_Emp", "@Id_Cd", "@Id_Fac", "@Id_FacSerie" };
                object[] Valores = { fac.Id_Emp, fac.Id_Cd, fac.Id_Fac, fac.Id_FacSerie  };
        ...
        public void ObtenerAcuse(Sesion sesion, int Cfe_TMov, ref string Cfe_NombreAcuse)
        {
            try
            {
                ...
                Object[] Valores = {  sesion.Id_Emp ,
                                       sesion.Id_Cd_Ver , 
                                        Cfe_TMov };
                SqlCommand sqlcmd = cd_datos.GenerarSqlCommand("spCatConsFactEle_ObtenerAcuse", ref dr, Parametros, Valores);

                dr.Read();
                Cfe_NombreAcuse = dr["Cfe_NombreAcuse"].ToString().Trim();
                dr.Close();
