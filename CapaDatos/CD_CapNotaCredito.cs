...
namespace CapaDatos
{
    public class CD_CapNotaCredito
    {
            ...
            , int? Id_Ncr_inicio, int? Id_Ncr_fin, int? Id_U)
        {
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    notaCredito.Id_Cd = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Cd")));
                    notaCredito.Id_Ncr = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Ncr")));
                    notaCredito.Id_NcrSerie = dr["Id_NcrSerie"].ToString().Trim();
                    notaCredito.Id_Cte = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Cte")));
        ...
        public void ConsultarAdenda(int Id_Emp, int Id_Cd_Ver, int Id_Ncr, string Tipo1, string Tipo2, ref List<AdendaDet> listCab, ref List<AdendaDet> listDet, string Conexion)
        {
            try
            {
                SqlDataReader dr = null;
        ...
        public void ConsultarIdNotaCredito(int Ncr_Referencia,int Id_Cd, int Id_Emp,  ref int Id_Nc,ref string Estatus,ref string Id_NcrSerie, string Conexion)
        {
            try
            {
                ...
                if (dr.Read())
                {
                    ...
                    Id_NcrSerie = dr["Id_NcrSerie"].ToString().Trim();
                }
